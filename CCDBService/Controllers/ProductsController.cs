...
namespace CCDBService.Controllers
{
    public class ProductsController : ApiController
    {
        ...
        // GET: api/Products?categoryid=int
        public IQueryable<Product> GetProductsByCategoryID(int categoryid)
        {
            return db.Products.Where(x => x.CategoryID == categoryid);
        }

        // GET: api/Products?supplierid=int
        public IQueryable<Product> GetProductsBySupplierID(int supplierid)
        {
            return db.Products.Where(x => x.SupplierID == supplierid);
        }

        // GET: api/Products?txtSearch=string
        public IQueryable<Product> GetSearch(string txtSearch)
        {
            return db.Products.Where(x => x.ProductName.Contains(txtSearch));
        }
